...
use Hereldar\DoctrineMapping\Fields\UnsignedSmallIntegerField;
use Hereldar\DoctrineMapping\Tests\TestCase;

final class UnsignedSmallIntegerFieldTest extends TestCase
{
    public function testParentClass(): void
    {
        $field = UnsignedSmallIntegerField::of('field');
    ...
    public function testColumn(): void
    {
        ...
        $field = UnsignedSmallIntegerField::of('field')->withColumn(
            name: $name,
