...
use Hereldar\DoctrineMapping\Fields\UnsignedIntegerField;
use Hereldar\DoctrineMapping\Tests\TestCase;

final class UnsignedIntegerFieldTest extends TestCase
{
    public function testParentClass(): void
    {
        $field = UnsignedIntegerField::of('field');
    ...
    public function testColumn(): void
    {
        ...
        $field = UnsignedIntegerField::of('field')->withColumn(
            name: $name,
