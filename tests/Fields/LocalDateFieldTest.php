...
use Hereldar\DoctrineMapping\Fields\LocalDateField;
use Hereldar\DoctrineMapping\Tests\TestCase;

final class LocalDateFieldTest extends TestCase
{
    public function testParentClass(): void
    {
        $field = LocalDateField::of('field');
    ...
    public function testDefaultType(): void
    {
        ...
        self::assertSame(Types::DATE_IMMUTABLE, $field->type());
    }
    ...
    public function testColumn(): void
    {
        ...
        $field = LocalDateField::of('field')->withColumn(
            name: $name,
