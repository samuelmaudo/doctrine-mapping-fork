...
final class IndexOptionsTest extends TestCase
{
    ...
    public function testEmptyOption(): void
    {
        ...
        $this->expectExceptionMessage("Invalid file 'EmptyOption.orm.php': Option keys of indexes should be non-empty strings, but '' was found");
    ...
    {
        $this->expectException(DoctrineMappingException::class);
        $this->expectExceptionMessage("Invalid file 'InvalidOption.orm.php': Option keys of indexes should be non-empty strings, but 42 was found");
